...
func main() {
	...
	for i := 0; i < 10; i++ {
		e.Current(i)
		e.From(fmt.Sprintf("example02%02d@gmail.com", i))
		e.To(fmt.Sprintf("example02%02d@gmail.com", i+1))
		e.Send(i)
	}
	...
	for i := 0; i < 10; i++ {
		go func(i int) {
			e.Current2(i).
				From2(fmt.Sprintf("example02%02d@gmail.com", i)).
				To2(fmt.Sprintf("example02%02d@gmail.com", i+1)).
				Send2(i)
		}(i)
	}
	time.Sleep(1 * time.Second)
